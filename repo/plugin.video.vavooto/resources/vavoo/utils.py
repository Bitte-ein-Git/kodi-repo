...
def getAuthSignature():
	...
	while i < 5:
		...
		try:
			...
			_data = {"token":"sCaE6wVbBh3GDdU1H6sHUAQOzRh9t0LnQSTaQLnK-x8pKJsRqESI1avNxWyP3hIE8ToDmKFIvZxJ27dCoXTVULrlWSsngdZyHPRD0HDrCmX1vJjSr6We-upkRMl8Fv7m2jQW","reason":"boot","locale":"de","theme":"dark","metadata":{"device":{"type":"Handset","brand":"google","model":"Nexus","name":"21081111RG","uniqueId":"d10e5d99ab665233"},"os":{"name":"android","version":"7.1.2","abis":["arm64-v8a"],"host":"android"},"app":{"platform":"android","version":"1.1.0","buildId":"97215000","engine":"hbc85","signatures":["6e8a975e3cbf07d5de823a760d4c2547f86c1403105020adee5de67ac510999e"],"installer":"com.android.vending"},"version":{"package":"tv.vavoo.app","binary":"4.3.9","js":"4.3.9"},"platform":{"isAndroid":True,"isIOS":False,"isTV":False,"isWeb":False,"isMobile":True,"isWebTV":False,"isElectron":False}},"appFocusTime":314,"playerActive":False,"playDuration":0,"devMode":True,"hasAddon":True,"castConnected":False,"package":"tv.vavoo.app","version":"4.3.9","process":"app","firstAppStart":1777415870151,"lastAppStart":1777415870151,"ipLocation":None,"adblockEnabled":False,"proxy":{"supported":["ss","openvpn"],"engine":"openvpn","ssVersion":1,"enabled":False,"autoServer":True,"id":"fi-hel"},"iap":{"supported":True}}
			req = request_json("POST", 'https://www.vavoo.tv/api/app/ping', json=_data, headers=_headers, timeout=10, retries=1)
